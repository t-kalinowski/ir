...
- Install persistent launchers for `exec/` tools and symlinks for opaque `bin/` executables with `ir tool install`; installed tool libraries live in the durable tool store.
